...
void Input::lua_Register( lua_State* lua )
{
	...
	/*luaL_Reg funcs[] =
	{
		...
		{ "GPConnected", lua_GPConnected },
		{ "GPDown", lua_GPDown },
		{ "GPUp", lua_GPUp },
		{ "GPPressed", lua_GPPressed },
		{ "GPReleased", lua_GPReleased },
		{ "LeftTrigger", lua_LeftTrigger },
		{ "RightTrigger", lua_RightTrigger },
		{ "LeftStick", lua_LeftStick },
		{ "RightStick", lua_RightStick },
	...
	// register XBOX gamepad
	lua_newtable( lua );
	GP( Up, XINPUT_GAMEPAD_DPAD_UP );
	GP( Down, XINPUT_GAMEPAD_DPAD_DOWN );
	GP( Left, XINPUT_GAMEPAD_DPAD_LEFT );
	GP( Right, XINPUT_GAMEPAD_DPAD_RIGHT );
